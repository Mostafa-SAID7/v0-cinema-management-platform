    ...
    public class SeedController : ControllerBase
    {
        ...
        public async Task<IActionResult> SeedUsers()
        {
            try
            {
                ...
                if (existingUsers.Any())
                    return Ok(BaseResponse<object>.Success(null, "Users already exist, skipping seed"));
                ...
                return Ok(BaseResponse<object>.Success(
                    ...
                    $"Successfully seeded {createdIds.Count} users"
                ));
            }
            catch (Exception ex)
            {
                return StatusCode(500, BaseResponse<object>.Failure($"Error seeding users: {ex.Message}"));
            }
        }
        ...
        public async Task<IActionResult> SeedAll()
        {
            try
            {
                ...
                return Ok(BaseResponse<object>.Success(null, "Successfully seeded all data (users, movies and screenings)"));
            }
            catch (Exception ex)
            {
